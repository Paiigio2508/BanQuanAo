...
export default function ThongKe() {
    ...
    const data = raw.map(d => ({ ...d, value: Number(d.value) || 0 })); // value phải là number
    ...
    const config = {
        ...
        label: {
            position: 'inside',
            offset: -10,
            text: (datum) => total ? `${((datum.value / total) * 100).toFixed(0)}%` : '0%',
            fontSize: 14,
            textAlign: 'center',
        },
        ...
        <div className="container-fluid">
            ...
            <div className="row g-3 align-items-stretch mt-4">
                <div className="col-md-8 d-flex">
                    <Card className="w-100 d-flex flex-column shadow h-100"
