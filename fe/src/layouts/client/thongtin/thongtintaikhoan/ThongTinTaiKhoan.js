...
import { KhachHangClientAPI } from "../../../../pages/api/client/KhachHangClientAPI";
const ThongTinTaiKhoan = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        const empRes = await KhachHangClientAPI.getOneByIdUser(id);
  ...
  const handleSuccess = () => {
    form.validateFields().then((values) => {
      ...
      KhachHangClientAPI.update(formData)
        .then(() => {
