...
public interface DanhMucRepository extends JpaRepository<DanhMuc, String> {
    @Query(value = """
    SELECT o.id as id,o.ma as ma ,o.ten as ten, o.trang_thai as trangThai FROM danh_muc o ORDER BY o.ngay_tao DESC
            """, nativeQuery = true)
    List<ThuocTinhRepo> getAllDanhMuc();
    ...
    ORDER BY o.ma DESC
            """, nativeQuery = true)
    List<ThuocTinhRepo> timDanhMuc(ThuocTinhSearchRequest bangConSearch);
}
